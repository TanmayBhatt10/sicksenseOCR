...
class MedicalReportAnalyzer:
    ...
    def extract_text_from_pdf(self, pdf_path, output_dir="temp_images"):
        ...
        if self.poppler_path:
            ...
            try:
                images = convert_from_path(pdf_path, dpi=300, poppler_path=r"C:\Program Files\poppler-25.07.0\Library\bin")
            except Exception as e:
                raise Exception(
                    f"Poppler not found. Initialize with poppler_path parameter.\n"
                    f"Example: analyzer = MedicalReportAnalyzer(poppler_path=r'C:\your\\poppler\\bin')"
                )
...
if __name__ == "__main__":
    ...
    # Analyze the report
    file_path = "lung_report.png"  # Can be .png, .jpg, or .pdf
